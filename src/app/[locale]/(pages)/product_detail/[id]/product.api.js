...
//   requestJson(`/api/get_cart_client`, {
//     method: "POST",
...
export const addProductToCart = (payload) =>
  requestJson(`/api/addProduct_in_cart_client`, {
    method: "POST",
    headers: { "Content-Type": "application/json" },
...
export const updateCartQuantity = (payload) =>
  requestJson(`/api/update_cart_quantite`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
    body: JSON.stringify(payload),
  });
...
export const linkCommentToProduct = ({ productId, commentId }) =>
  requestJson(`/api/add_commante_in_product`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
...
export const fetchProductComments = (productId) =>
  requestJson(`/api/get_comments_by_product?id=${productId}`, {
    method: "GET",
    cache: "no-store",
  });
...
export const fetchRelatedProducts = (productId, limit = 8) =>
  requestJson(
    `/api/get_related_products?id=${productId}&limit=${limit}`
  );
