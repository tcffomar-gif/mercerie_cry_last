    ...
    <div className="max-w-2xl w-full bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 space-y-8">
      ...
      <div className="space-y-4">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 text-[#D4B814] hover:text-[#EDD658] transition-colors duration-300"
        >
          <svg
          ...
          <span dir="ltr" className="text-xl dark:text-[#EDD658]">@crystalmercerie</span>
        </Link>
      </div>
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <span dir="ltr" className="text-xl dark:text-[#EDD658]">07 82 72 02 66</span>
        </Link>
      </div>
